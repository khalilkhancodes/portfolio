    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          <div
            className={`flex flex-wrap gap-4 mb-8 transition-all duration-700 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <Button
              size="lg"
          ...
          <div
            className={`flex gap-4 transition-all duration-700 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <LightTooltip title="GitHub" placement="bottom">
              ...
              >
                <a
                  href="https://github.com/khalilkhancodes"
                  target="_blank"
            ...
            <LightTooltip title="LinkedIn" placement="bottom">
              ...
              >
                <a
                  href="https://www.linkedin.com/in/khalilkhancodes"
                  target="_blank"
                  rel="noopener noreferrer"
